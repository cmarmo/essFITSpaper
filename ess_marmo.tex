...
%However, INSERT HERE COMMENTS FROM REVIEWER #2.
...
However, solar system imagery data has been traditionally described using terrestrial based
reference systems.
Engineers and cartographers working in spatial missions are closer to Earth observation
techniques and standards than the astronomy one.
Furthermore, geospatial standardization in FITS dates back to the 2000s, when planetary
surface research habits had already been installed.
Where astronomers and planetary scientists work closer, in small bodies investigations,
FITS format is already more popular.

Why is changing?

- Too many raster images : problem of processing efficiency.
- Europe and Asia bring more astronomers to the surface planetary investigation.
