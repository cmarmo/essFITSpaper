...
giving chances to optimize data processing across the planetary and astronomy domains.
...
FITS is an open digital standard, defined for data acquisition and archiving telescope data
by astronomical observatories since the late 1970's.
...
\label{ssec:geofits}
To facilitate surface investigations, data taken of a planetary surface should be radiometrically calibrated and orthorectified (when topographic data is available) into a well-known map projection as required by Geographical Information Systems (GIS) applications.
