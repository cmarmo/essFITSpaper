...
\begin{keypoints}
\item We present an extension of FITS metadata description for planetary surface
investigations. 
\item A FITS description for planetary data aims
to simplify sharing data across the planetary and astronomy domains.
\item FITS open description metadata will promote interoperability from raw data
