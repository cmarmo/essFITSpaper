...
In addition, WCS resolves the ambiguity between east-positive and west-posited
...
Up to now it provides access to public data from 5 different targets (i.e., Mercury, Venus, Mars,
...
We used the planetary FITS standard described in this work in order to make the output file compliant
with the great part of the FITS readers, DS9 and JS9 above all.
...
Aladin\footnote{http://aladin.u-strasbg.fr/} and its HiPS generator have been updated to support
several planetary conventions.
