...
%
\appendix
\section{Correspondence between reserved FITS keywords and PDS4 standard reference}
\label{app:stdfitspds4}
...
and PDS4 attributes, is described in this Appendix.
\begin{itemize}
\item{\texttt{BITPIX}.
