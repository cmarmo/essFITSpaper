...
\item{dictionaries between FITS and PDS meta-data description;}
...
There is no need for oblique projection definitions \citep{calagreisenI,Snyder1987}
...
conversion in world coordinates is set by an oriented matrix.

\begin{table}
\label{table:proj}
\caption{Projection names and codes already available in FITS suitable for
planetary applications: their translation in PDS4 vocabulary is
provided. See Table A.1. in \citet{calagreisenI} for details.}
\centering
\begin{tabular}{l l l}
\hline
