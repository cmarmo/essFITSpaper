...
\begin{enumerate}
\item{a brief description of FITS format and on its pros and cons in using it in
planetary science;}
...
FITS\footnote{https://fits.gsfc.nasa.gov/} \citep{fitsorig,fitsver3} stands for
...
4\footnote{https://pds.nasa.gov/tools/standards-reference.shtml} archiving
specifications and supported by a large number of open libraries and software tools.
...
Transverse Mercator or Simple Cylindrical and
...
\begin{tabular}{l l l}
\hline
FITS Name$^{a}$ & FITS code$^{a}$ & PDS name \\ 
\hline
Sanson-Flamsteed & SFL & \\
Zenithal Equal-Area & ZEA & \\
Conic ortomorphic & COO & \\
Plate Carre & CAR & \\
generalization of Lambert Equal-Area & CEA \\
Mercator & MER & \\
Ortographic & SIN & \\
Zenithal perspective & AZP & \\
Stereographic & STG & \\
\hline
